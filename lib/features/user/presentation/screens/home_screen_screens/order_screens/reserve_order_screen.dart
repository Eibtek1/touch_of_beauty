        ...
        padding: EdgeInsets.symmetric(horizontal: 15.w,vertical: 15.h),
          children: [
            ...
            SizedBox(
              ...
              child: ListView.builder(itemBuilder: (BuildContext context, int index) { return const OrderItemWidget(); },itemCount: 2,),
            ),
            ...
            SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  fontSize: 16.sp,
                  fontFamily: FontPath.almaraiBold,
                  color: index != 0?const Color(0xff1E2432):const Color(0xffB83561)))
                    ],
                  );
                },
              ),
            ...
            SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  }, icon: SvgPicture.asset(SvgPath.chatIcon,width: 60.w,height: 60.h,)),
                  SizedBox(height:45.h,child: CustomUserButton(buttonTitle: 'اطلب الان', isTapped: (){
                    Navigator.pushNamed(context, ScreenName.chooseAddressScreen);
                  }, width: 124.w, paddingVertical: 0, paddingHorizontal: 0,))
                ],
              ),
            ),
            SizedBox(height: 25.h,),
            ...
            SizedBox(height: 14.h,),
            CustomUserTextField(hintText: 'اكتب ملاحضاتك', height: 150.h,),
