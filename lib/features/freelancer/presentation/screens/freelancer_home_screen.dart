...
import '../../../vendor/presentation/widgets/should_add_work_hours.dart';
...
class _FreelancerHomeScreenState extends State<FreelancerHomeScreen> {
  ...
  void checkWorkTimeList() {
    BlocListener<WorkHoursCubit, WorkHoursState>(
                              ...
                              if (value != null) {
                                if (dayValue == LocaleKeys.today.tr()) {
                                  ...
                                  cubit.endDate = DateTime.now()
                                      ...
                                      .toString();
                                  VReservationCubit.get(context).getTodayOrders(
                                      inHome: value == LocaleKeys.in_center.tr()
                                          ? false
                                          : true);
                                } else {
                                  cubit.startDate = DateTime.now()
                                ...
                                Fluttertoast.showToast(
                                    msg: LocaleKeys.chooseServicesType.tr(),
