...
class FreelancerNotificationScreen extends StatefulWidget {
  const FreelancerNotificationScreen({Key? key}) : super(key: key);

  @override
  State<FreelancerNotificationScreen> createState() => _FreelancerNotificationScreenState();
}

class _FreelancerNotificationScreenState extends State<FreelancerNotificationScreen> {
  @override
  void initState() {
