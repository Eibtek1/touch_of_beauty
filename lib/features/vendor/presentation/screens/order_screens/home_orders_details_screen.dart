                ...
                Expanded(
                  child: ListView(
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                const Icon(Icons.location_on,color: AppColorsLightTheme.secondaryColor,),
                                Text(
                                  'عنوان العميل',
                                  style: TextStyle(
                                      color: Colors.black,
                            ...
                            const AddressDetailsItemBuilder(title: 'المدينة', subTitle: 'الرياض'),
                            const DividerBuilder(),
                            const AddressDetailsItemBuilder(title: 'المنطقة', subTitle: 'مدينة الرياض'),
                            const DividerBuilder(),
                            const AddressDetailsItemBuilder(title: 'اسم الشارع', subTitle: 'صلاح الدين'),
                            const DividerBuilder(),
                            const AddressDetailsItemBuilder(title: 'رقم المبني', subTitle: '66'),
                            const DividerBuilder(),
                            const AddressDetailsItemBuilder(title: 'الطابق', subTitle: '10'),
                            const DividerBuilder(),
                            const AddressDetailsItemBuilder(title: 'رقم الهاتف', subTitle: '056448468'),
                            SizedBox(
                              height: 14.h,
                            ),
                          ],
                      ...
                      CustomVendorButton(
                          buttonTitle: 'في الطريق الي العميل',
                          isTapped: () {},
                          width: double.infinity,
